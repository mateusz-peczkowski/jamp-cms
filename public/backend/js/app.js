...
var InitControls = function(el) {

    return function(el){

        // Initialize Select2
        $('.select-select2', el).select2();
            
    }

}();

var InitDialogsControls = function(el) {
    ...
    return function(el){
        ...
        tinymce_dialog_conf = {
            ...
            selector: "#modal-fade textarea.editor",
            forced_root_block : "", 
        ...
        tinymce.init(tinymce_dialog_conf);
    }
